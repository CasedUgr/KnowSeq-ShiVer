...
write.csv2(labels, file = paste0("../saved_files/higado_", numero_de_genes, "genes_labels.csv"), row.names = F)
write.csv2(DEGsMatrix, file = paste0("../saved_files/higado_", numero_de_genes, "genes_DEGsMatrix.csv"))
